...
function SessionReportingButton({ store, wide }: { store: Store; wide: boolean }): any {
  ...
  return createElement('button', { type: 'button', className: 'dsh-sr-button', title: 'Session 上报', 'aria-label': 'Session 上报', 'aria-expanded': state.open, onClick: () => store.setOpen(!state.open) }, createElement(Database, { size: 18 }), wide ? createElement('span', { className: 'dsh-sr-label' }, 'Session') : null)
}
...
const STYLES = `.dsh-sr-button{display:flex;align-items:center;gap:10px;width:100%;min-width:0;padding:8px 10px;border:0;border-radius:8px;background:transparent;color:var(--dsw-alias-label-secondary,#555);cursor:pointer;font:inherit}.dsh-sr-button:hover{background:var(--dsw-alias-bg-hover,rgba(0,0,0,.05))}.dsh-sr-label{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.dsh-sr-overlay{position:absolute;inset:0;display:flex;justify-content:flex-end;background:rgba(0,0,0,.18)}.dsh-sr-drawer{width:min(560px,calc(100vw - 24px));height:100%;overflow:hidden;display:flex;flex-direction:column;background:var(--dsw-alias-bg-layer-2,#fff);border-left:1px solid #ddd}.dsh-sr-header{display:flex;justify-content:space-between;align-items:center;padding:16px;border-bottom:1px solid #ddd}.dsh-sr-header>div{display:flex;gap:8px;align-items:center}.dsh-sr-header button{border:0;background:transparent;cursor:pointer}.dsh-sr-list{overflow:auto}.dsh-sr-session{border-bottom:1px solid #eee}.dsh-sr-session-row{display:flex;align-items:flex-start;gap:8px;width:100%;padding:13px 16px;border:0;background:transparent;text-align:left;cursor:pointer;color:inherit}.dsh-sr-session-row div{min-width:0}.dsh-sr-session-row strong,.dsh-sr-session-row small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.dsh-sr-session-row small{margin-top:4px;color:#777}.dsh-sr-open{transform:rotate(90deg)}.dsh-sr-events{padding:0 16px 12px 38px}.dsh-sr-event{padding:8px 0;border-top:1px solid #eee}.dsh-sr-event code{font-size:11px;color:#555}.dsh-sr-event pre{max-height:180px;overflow:auto;white-space:pre-wrap;word-break:break-word;font-size:11px}.dsh-sr-empty,.dsh-sr-error{padding:32px;text-align:center}.dsh-sr-error{color:#b42318}`
